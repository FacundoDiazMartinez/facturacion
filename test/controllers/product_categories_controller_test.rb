...
class ProductCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_category" do
    assert_difference('ProductCategory.count') do
      post product_categories_url, params: { product_category: { active: @product_category.active, company_id: @product_category.company_id, iva_aliquot: @product_category.iva_aliquot, name: @product_category.name, products_count: @product_category.products_count } }
    end
  ...
  test "should update product_category" do
    patch product_category_url(@product_category), params: { product_category: { active: @product_category.active, company_id: @product_category.company_id, iva_aliquot: @product_category.iva_aliquot, name: @product_category.name, products_count: @product_category.products_count } }
