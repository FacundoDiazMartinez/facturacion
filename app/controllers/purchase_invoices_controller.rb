class PurchaseInvoicesController < ApplicationController
  ...
  def create
    ...
    if @purchase_invoice.save
      redirect_to '/purchase_invoices', notice: 'Comprobante de compra cargado correctamente.'
    else
      render :new
    end
  end
  ...
  def update
    if @purchase_invoice.update(purchase_invoice_params)
      redirect_to '/purchase_invoices', notice: 'Comprobante de compra actualizado correctamente.'
    else
      render :edit
    end
  end
